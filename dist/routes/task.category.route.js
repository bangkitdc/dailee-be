...
class TaskCategoryRoute {
    ...
    taskCategoryService = new task_category_service_1.TaskCategoryService();
    taskCategoryController = new task_category_controller_1.TaskCategoryController(this.taskCategoryService);
    constructor() {
